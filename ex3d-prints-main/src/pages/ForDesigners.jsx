          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-none shadow-lg">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold mb-4">Earn Additional 20% on Affiliate Purchases</h3>
                <p className="text-slate-600">
                  Earn an extra 20% commission when your followers purchase through your referral link.
                </p>
              </CardContent>
            </Card>
          </div>
