...
export default function ForMakers() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setMakerCount(res.data?.maker_count || 0);
        setStatesCount(res.data?.states_count || 0);
      } catch (error) {
  ...
  return (
    <div className="min-h-screen">
      <MakersHeroSection paidToMakers={totalRevenue} makerCount={makerCount} statesCount={statesCount} loading={loading} />
      <RequirementsSection />
