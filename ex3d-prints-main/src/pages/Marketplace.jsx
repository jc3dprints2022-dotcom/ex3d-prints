...
export default function Marketplace() {
  ...
  const loadProducts = async () => {
    ...
    setLoading(true);
    try {
      // Filter at query level — don't fetch inactive products at all
      const activeProducts = await base44.entities.Product.filter({ status: 'active' });
