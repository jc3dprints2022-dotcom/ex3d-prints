    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Share your creations and earn rewards — review takes under an hour</p>
        </div>
        ...
        <Card className="border-2 border-red-200 shadow-2xl">
            ...
            <CardContent>
              ...
              <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-red-500 to-pink-600" disabled={submitting}>
                {submitting ? <><Loader2 className="w-4 h-4 mr-2 animate-spin"/>Creating Account...</> : 'Complete Signup'}
              </Button>
            </form>
          </CardContent>
        </Card>
