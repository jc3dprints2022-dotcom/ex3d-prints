...
export default function MakersHeroSection({ paidToMakers, makerCount, statesCount, loading }) {
          ...
          <div className="flex items-center justify-center">
            ...
            >
              <CardContent className="p-8">
                ...
                {!loading && makerCount > 0 && (
                  <p className="text-sm mt-3 text-white/80">{makerCount} makers across {statesCount} states</p>
                )}
              </CardContent>
            </Card>
          </div>
