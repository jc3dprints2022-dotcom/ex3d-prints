        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-700 text-lg leading-relaxed mb-6">
              I'm Jacob, an aerospace engineering student who helps build real rocket engines. I started EX3D Prints to bring high quality 3d printed items to people across the United States and be able to deliver items much faster and for cheaper then giant print farms.
            </p>
            <Button
              className="bg-teal-600 hover:bg-teal-700 text-white font-bold"
              onClick={() => { window.location.href = "/About"; window.scrollTo(0, 0); }}
            >
              About
            </Button>
          </div>
