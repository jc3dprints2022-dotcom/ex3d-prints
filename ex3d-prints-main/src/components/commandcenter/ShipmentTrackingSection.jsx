                      ...
                      <div className="grid md:grid-cols-3 gap-3 text-sm mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-slate-300 text-xs leading-relaxed">
                            ...
                            {order.shipping_address?.street}{order.shipping_address?.street2 && <>, {order.shipping_address.street2}</>}<br />
                            {order.shipping_address?.city}, {order.shipping_address?.state} {order.shipping_address?.zip}
                            {order.shipping_address?.country && order.shipping_address.country !== 'US' && (
                              <><br /><span className="text-yellow-400 font-medium">{order.shipping_address.country_name || order.shipping_address.country} 🌍</span></>
                            )}
                          </p>
                        </div>
                        <div>
