...
import { Package, DollarSign, TrendingUp, Eye, ShoppingCart, PlusCircle, Loader2, Pencil, Trash2, Settings, Megaphone } from "lucide-react";
...
import DesignerMetricsBar from "./DesignerMetricsBar";
...
export default function DesignerDashboardContent({ user, onUpdate }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Designer growth metrics */}
      <div className="mb-6">
        <DesignerMetricsBar user={user} products={products} />
      </div>
                ...
                <Card key={product.id} className={`border-2 ${
                  ...
                  <CardContent className="p-4 md:p-6">
                    <div className="flex flex-col md:flex-row gap-4">
                      {product.images?.[0] && (
                        <img src={product.images[0]} alt={product.name} className="w-full md:w-24 h-24 object-contain rounded" />
                      )}
