...
const PRODUCT_URL = "/ProductDetail?id=saturn-v";
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white font-sans">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-10 max-w-xl mx-auto leading-relaxed">
            A 56cm precision-printed Saturn V model kit. No paint. No glue. Just you and the most iconic rocket ever flown.
          </p>

          {/* Hero Image */}
          <div className="mb-10 mx-auto w-full max-w-sm aspect-[3/4] rounded-2xl overflow-hidden border border-gray-700 bg-gray-900 flex items-center justify-center">
      ...
      <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto flex flex-col md:flex-row gap-10 items-center">
          {/* Photo placeholder */}
          <div className="w-48 h-48 flex-shrink-0 rounded-full border-2 border-orange-500/40 bg-gray-900 flex items-center justify-center mx-auto">
            <div className="text-center text-gray-600">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-loose text-lg">
              I'm Jacob. I'm an aerospace engineering student who helps build real rocket engines. I printed this because I wanted something on my desk that actually meant something. Now I make them for people who feel the same way.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { label: "Color", value: "Authentic black & white roll pattern — printed in filament, no paint" },
              { label: "Assembly", value: "Ships as a precision kit — press-fit, no glue required" },
              { label: "Print Quality", value: "0.2mm layer height, 20% infill structural core" },
            ].map((spec) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs tracking-[0.4em] text-orange-400 uppercase mb-4">Reviews</p>
          <h2 className="text-3xl font-bold mb-12">What People Are Saying</h2>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { name: "A.M.", text: "Sits on my desk at NASA JPL. Every visitor asks about it." },
              { name: "T.K.", text: "Perfect detail. The roll pattern is spot-on. Worth every dollar." },
              { name: "R.S.", text: "Got it as a gift for my dad who watched Apollo 11 live. He teared up." },
            ].map((review) => (
              <div key={review.name} className="bg-gray-900 border border-gray-800 rounded-xl p-6 text-left">
                <div className="flex text-yellow-400 mb-3">{"★★★★★"}</div>
                <p className="text-gray-300 text-sm leading-relaxed mb-3">"{review.text}"</p>
                <p className="text-gray-600 text-xs">— {review.name}</p>
              </div>
            ))}
          </div>
          <p className="text-gray-600 text-xs mt-6 italic">More reviews coming as orders ship.</p>
        </div>
      </section>
