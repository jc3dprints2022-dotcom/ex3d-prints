...
// Dynamic ship-by date (today + 3 business days)
...
export default function RocketCollection() {
  ...
  const faqs = [
    { q: "How long until my rocket arrives?",           a: `Order today and it ships within 2-4 days. ${shipByDate}. It's printed by a maker near you across our network of ${MAKER_COUNT} makers in ${MAKER_STATES} states, shipped domestically, not from overseas.` },
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      {/* TOP NAV / LOGO */}
      <div className="relative z-50 w-full px-6 py-3 flex items-center justify-between border-b border-gray-800/50 bg-[#0a0a0f]">
        <div />
        <img
        ...
        />
        <span style={{display:"none"}} className="text-white font-bold text-sm tracking-widest">EX3D PRINTS</span>
        <div />
      </div>
      ...
      <section className="relative flex flex-col items-center justify-center px-6 text-center overflow-hidden pt-8 pb-10">
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          <div className="flex justify-center items-end gap-3 sm:gap-6 md:gap-10 mb-5 w-full px-2">
            {[
              { src: SATURN_V_GALLERY[0], alt: "Saturn V",  label: "Saturn V · 22 inches",  border: "border-orange-500/30" },
              { src: SLS_GALLERY[0],      alt: "SLS",        label: "SLS · 19 inches",       border: "border-blue-500/30"   },
      ...
      <section className="py-10 px-6 border-t border-gray-800 bg-[#0d0d18]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm mb-8 max-w-md mx-auto">
            The rocket that took humanity to the Moon. The rocket taking humanity back. Made to order. Both at 1:200 scale, quality-checked before they ship, in your hands within 2-4 days.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-gradient-to-b from-orange-900/30 to-gray-900 border-2 border-orange-500/60 rounded-2xl p-5 flex flex-col relative">
              ...
              <p className="text-gray-600 text-xs mb-3">Ships by {shipByDate}</p>
              <p className="text-gray-400 text-sm flex-1">Both models together. Apollo to Artemis. The complete Moon missions story at 1:200 scale.</p>
      ...
      <section className="py-10 px-6 border-t border-gray-800 bg-[#0d0d18]">
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed text-sm mb-3">
              Every model is designed by <span className="text-white font-semibold">kmobrain (AstroDesign 3D)</span>, printed by a verified maker near you, and quality-checked before it ships.             </p>
