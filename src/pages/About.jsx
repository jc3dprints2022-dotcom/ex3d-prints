...
export default function About() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-[#0a0a0f] py-24 text-center px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs tracking-[0.4em] text-orange-400 uppercase mb-4">EX3D Prints</p>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Built by Someone Who Loves Space</h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-16">
        ...
        <div className="text-center pt-4">
          <Link to="/SaturnV">
            <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white font-bold px-10">
