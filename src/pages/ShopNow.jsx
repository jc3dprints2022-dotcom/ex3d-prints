...
import { Search, X, Upload, SlidersHorizontal, Star, Loader2 } from "lucide-react";
...
export default function ShopNow() {
  ...
  const loadProducts = async () => {
    if (searchQuery.trim()) return searchWithAlgolia();
      ...
      <div className="bg-white border-b sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {/* Upload button — icon-only on mobile, full label on sm+ */}
            <Button asChild className="bg-teal-600 hover:bg-teal-700 text-white shadow flex-shrink-0 px-2 sm:px-4" size="default">
